...
import com.muhammadshandy.listfilmuts.databinding.FragmentListMovieBinding
...
class ListMovieFragment : Fragment() {
    ...
    private fun setListener() {
        binding.btnFavorite.setOnClickListener {
            findNavController().navigate(R.id.action_listMovieFragment_to_favoriteMovieFragment)
        }
    }
